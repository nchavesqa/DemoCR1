...
describe('Landing Referidos Iberia', ()=> {
    ...
    it('Referidos Iberia - Camino feliz', ()=>{
        ...
        cy.get('#c559d483-4aab-4e5e-b4e7-2395f4e764af').type('Natalia Chaves').tab().type('12345678').tab().type('nat@prueba.com')
        cy.wait(time)
    ...
    it.only('Referidos Iberia - Mensajes de error por Campos Vacíos', ()=>{
